---
title: "Zootopia 2 - 3-Part A2 Story"
date: "2026-05-27"
type: "movie_story"
level: "A2 Key for Schools"
parts: 3
images: 3
source: "Original simplified story inspired by the film world"
---

# Zootopia 2 - 3-Part Story

This is an original, simplified A2-level story inspired by *Zootopia 2*. It is not an official movie text.

## Part 1 - A New Case

![Part 1 - A New Case](./movie_story_2026-05-27_animal-city-2-3-parts_part1.svg)
...
**Image prompt:** Extract the visual characteristics of the characters in this story, but remove all copyrighted names. Create a family-friendly cartoon animal-city illustration. Show a small grey rabbit officer in a blue uniform, a clever orange fox partner in a green jacket, and a worried blue snake near a busy train station in a modern animal city. Use soft shapes, bright city colours, expressive faces, an adventurous but not scary mood, and a wide 16:9 composition. No text in the image.

## Part 2 - The Hidden Truth

![Part 2 - The Hidden Truth](./movie_story_2026-05-27_animal-city-2-3-parts_part2.svg)
...
**Image prompt:** Extract the visual characteristics of the characters in this story, but remove all copyrighted names. Create a family-friendly cartoon animal mystery scene. Show a small grey rabbit officer, an orange fox partner, and a blue snake inside an old archive room with shelves, old papers, soft glowing lights, and a map on a table. The three characters are working together to understand the truth. Use a warm, hopeful, child-friendly storybook style, not scary, 16:9 composition, no text in the image.

## Part 3 - Back Home

![Part 3 - Back Home](./movie_story_2026-05-27_animal-city-2-3-parts_part3.svg)
...
**Image prompt:** Extract the visual characteristics of the characters in this story, but remove all copyrighted names. Create a family-friendly cartoon ending scene. Show a small grey rabbit officer, an orange fox partner, and a blue snake standing together near an old family house by water at the edge of a green animal city. Other animals watch kindly as the truth is found. Use warm golden light, trees, a hopeful ending mood, child-friendly storybook cartoon style, 16:9 composition, no text in the image.
